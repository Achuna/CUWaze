...
blockageNodes = []  # (A, B, Boolean) blockage edge and drawLine
longTermBlockages = [(524, 1064, 15, True)]  # (X, Y, radius, Boolean)
travelTime = "Travel TIme 0s"
...
#encoding = cv2.imencode('.png', image)[1]
# encoding = encoding.tobytes()
#encoding = np.array(encoding).tostring()

f = open("testImg.png", "rb")
f.read()
...
#
#
# nparr = np.frombuffer(encoding, dtype='int8')
# img_decode = cv2.imdecode(nparr, cv2.IMREAD_COLOR)
#
# cv2.imwrite("testImg.png", img_decode)
